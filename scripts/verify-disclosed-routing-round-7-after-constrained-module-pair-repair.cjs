...
const baselineRelativePath = "docs/research/evidence/disclosed-routing-round-7-after-task-anchored-module-pair-repair-0.4-alpha.json";
...
const studyId = "disclosed-routing-round-7-after-constrained-module-pair-repair-0.4-alpha";
const candidateCommit = "228c3bde47f6930023496fdd0a54d43dba10091f";
const candidateCliSha256 = "E81774B89C3A6FAED83788335688EFCBC8B4D17DEA25CA002097FF1F9125318F";
const previousCandidateCommit = "cea2fd91f85726603f8f04de23d127e766caf198";
...
const baselineSha256 = "075BADB394CA1230252AB9F9710E90F88E37262E08CD7D837E95EA259DAE64F5";
...
async function main() {
  ...
  const temporaryRoot = await mkdtemp(
    path.join(os.tmpdir(), "vertex-palace-disclosed-routing-round-7-constrained-module-pair-")
  );
  ...
  try {
    ...
    report = {
      ...
      failures,
      claimBoundary: "Post-failure static routing regression on the eight disclosed Round 7 tasks after restricting sparse-test admission to task-anchored module mirrors. It can detect repairs and regressions on known failures, but cannot establish held-out generalization or end-to-end Agent correctness, Token, tool-call, or wall-time gains.",
      heldOutAgainstCandidate: false,
      evidenceClass: "seen-development-regression",
      candidate: {
        productCommit: candidateCommit,
        repair: "task-anchored-module-pair-v2-constrained-sparse-test",
    ...
    if (process.env.KEEP_DISCLOSED_ROUTING_ROUND_7_CONSTRAINED_MODULE_PAIR_TEMP === "1") {
