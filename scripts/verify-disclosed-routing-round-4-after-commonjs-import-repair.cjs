...
const studyId =
  "disclosed-cross-repository-routing-round-4-after-commonjs-import-repair-0.4-alpha";
...
async function main() {
  ...
  const temporaryRoot = await mkdtemp(
    path.join(os.tmpdir(), "vertex-palace-disclosed-routing-round-4-commonjs-")
  );
