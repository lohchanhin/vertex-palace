...
const studyId =
  "disclosed-cross-repository-routing-round-4-after-scoped-causal-repair-0.4-alpha";
...
const candidateCommit = "569f7c502fad06790784449e537223c9746e1312";
const candidateCliSha256 =
  "7CF0B35BCE86D953A561038B2BA2F339B9B468BFDC685FB87BA128327E35F101";
...
async function main() {
  ...
  const temporaryRoot = await mkdtemp(
    path.join(os.tmpdir(), "vertex-palace-disclosed-routing-round-4-repair-")
  );
