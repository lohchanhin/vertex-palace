...
const studyId = "disclosed-routing-regression-round-2-0.4-alpha";
const candidateCommit = "aed6ce6165ef68c261740a530d02110f8a2b7e11";
...
async function main() {
  ...
  const temporaryRoot = await mkdtemp(path.join(os.tmpdir(), "vertex-palace-disclosed-routing-round-2-"));
  assert.ok(
