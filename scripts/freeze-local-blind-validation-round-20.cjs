...
const freezeRelativePath = "docs/research/evidence/local-blind-routing-validation-freeze-0.4-stable-round-20.json";
const artifactPaths = [
  ...
  "scripts/create-round20-coherence-reviews.cjs",
...
function outputArgument(args) {
  ...
  assert.equal(resolved, path.join(projectRoot, freezeRelativePath), "Round 20 validation freeze must use its canonical path");
  return resolved;
}
