...
const studyId =
  "disclosed-cross-repository-routing-round-4-after-scope-graph-repair-0.4-alpha";
...
const candidateCommit = "e7be022ee900f2a620b3ea21791a58b229d6dc7c";
const candidateCliSha256 =
  "C7573B4E108020D86CF66A93FE379D430920EA3F809A1A7CC458CCB5F0BD8B8A";
...
async function main() {
  ...
  const temporaryRoot = await mkdtemp(
    path.join(os.tmpdir(), "vertex-palace-disclosed-routing-round-4-scope-graph-")
  );
