...
2. Show why flat repository exploration creates broad search, repeated reading,
   and forgotten decisions.
3. Explain the repository-to-index-to-adaptive-context-to-task route.
