...
const PHRASE_KEYWORDS: Array<[RegExp, string[]]> = [
  ...
  [/documentation|\bdocs?\b|readme|bilingual|locali[sz](?:e|ed|ation)|simplified\s+chinese|简体中文(?:辅助)?说明|簡體中文(?:輔助)?說明|双语|雙語|文档|文檔/i, ["docs", "documentation", "readme", "bilingual", "localization"]],
